...
- (void) setupPhysicsBody{
    ...
    self.physicsBody.categoryBitMask = WVCollisionCategoryProjectile;
    self.physicsBody.collisionBitMask = 0;
    self.physicsBody.contactTestBitMask = WVCollisionCategoryCocktail | WVCollisionCategoryGround;
